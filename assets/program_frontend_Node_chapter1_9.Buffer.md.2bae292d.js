import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.419948d5.js";const B=JSON.parse('{"title":"Buffer","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter1/9.Buffer.md","filePath":"program/frontend/Node/chapter1/9.Buffer.md","lastUpdated":1697287289000}'),p={name:"program/frontend/Node/chapter1/9.Buffer.md"},o=l(`<h1 id="buffer" tabindex="-1">Buffer <a class="header-anchor" href="#buffer" aria-label="Permalink to &quot;Buffer&quot;">​</a></h1><p>Buffer 中文译为“缓冲区”，本质上是一个类似于Array的对象，用于表示固定长度的字节序列</p><blockquote><p>字节序列是指多字节数据在计算机内存中存储或者网络传输时各字节的存储顺序。</p></blockquote><p>通俗讲，Buffer 就是一段固定长度的内存空间，用于处理二进制数据。</p><p>Buffer 特点：</p><ul><li>大小固定且无法调整</li><li>性能较好，可以直接操作计算机内存</li><li>Buffer中每个元素的大小为1字节（byte）</li></ul><blockquote><p>1byte = 8bit，通俗讲，就是用8个0或1表示</p></blockquote><p>Buffer的创建主要有3种方式：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 1.alloc</span></span>
