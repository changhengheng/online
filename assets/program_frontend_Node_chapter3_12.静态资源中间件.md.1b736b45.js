import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.19358895.js";const d=JSON.parse('{"title":"静态资源中间件","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter3/12.静态资源中间件.md","filePath":"program/frontend/Node/chapter3/12.静态资源中间件.md","lastUpdated":1697287289000}'),l={name:"program/frontend/Node/chapter3/12.静态资源中间件.md"},o=p(`<h1 id="静态资源中间件" tabindex="-1">静态资源中间件 <a class="header-anchor" href="#静态资源中间件" aria-label="Permalink to &quot;静态资源中间件&quot;">​</a></h1><p>静态资源指代码在运行期间长时间不会发生变化的资源，比如html、css、js、图片等等</p><p>静态资源目录也叫网站根目录，浏览器发送请求到服务器，服务器去哪个文件夹找对应的资源文件，这个文件夹就是网站根目录</p><p>express 内置处理静态资源的中间件</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">const</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">express</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">=</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">require</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&quot;express&quot;</span><span style="color:#E1E4E8;">);</span></span>
