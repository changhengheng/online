import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const A=JSON.parse('{"title":"readonly和shallowReadonly","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Vue/Vue3/1.组合API/15.readonly和shallowReadonly.md","filePath":"program/frontend/Vue/Vue3/1.组合API/15.readonly和shallowReadonly.md","lastUpdated":1694412824000}'),p={name:"program/frontend/Vue/Vue3/1.组合API/15.readonly和shallowReadonly.md"},o=l(`<h1 id="readonly和shallowreadonly" tabindex="-1">readonly和shallowReadonly <a class="header-anchor" href="#readonly和shallowreadonly" aria-label="Permalink to &quot;readonly和shallowReadonly&quot;">​</a></h1><p>readonly 用于创建深度只读数据。获取一个对象 (响应式或纯对象) 或 ref 并返回原始代理的只读代理。只读代理是深层的：访问的任何嵌套 property 也是只读的。</p><p>shallowReadonly 用于创建浅只读数据。创建一个代理，使其自身的 property 为只读，但不执行嵌套对象的深度只读转换，也就是只有最外层对象的属性是只读的，内层嵌套的对象的属性都不是只读的。</p><p>应用场景：在某些特定情况下, 我们可能不希望对数据进行更新的操作, 那就可以包装生成一个只读代理对象来读取数据, 而不能修改或删除</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#B392F0;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
