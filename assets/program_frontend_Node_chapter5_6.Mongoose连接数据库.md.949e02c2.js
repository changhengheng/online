import{_ as s,o as n,c as o,Q as a}from"./chunks/framework.19358895.js";const u=JSON.parse('{"title":"Mongoose 连接数据库","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter5/6.Mongoose连接数据库.md","filePath":"program/frontend/Node/chapter5/6.Mongoose连接数据库.md","lastUpdated":1697452647000}'),l={name:"program/frontend/Node/chapter5/6.Mongoose连接数据库.md"},p=a(`<h1 id="mongoose-连接数据库" tabindex="-1">Mongoose 连接数据库 <a class="header-anchor" href="#mongoose-连接数据库" aria-label="Permalink to &quot;Mongoose 连接数据库&quot;">​</a></h1><ol><li><p>初始化包</p><div class="language-yarn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yarn</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">yarn init -y</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">yarn init -y</span></span></code></pre></div></li><li><p>安装 mongoose</p><div class="language-yarn vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yarn</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">yarn add mongoose</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">yarn add mongoose</span></span></code></pre></div></li><li><p>使用</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 1. 导入 mongoose</span></span>
