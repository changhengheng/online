import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const F=JSON.parse('{"title":"获取请求体","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter1/46.获取请求体.md","filePath":"program/frontend/Node/chapter1/46.获取请求体.md","lastUpdated":1697287289000}'),p={name:"program/frontend/Node/chapter1/46.获取请求体.md"},o=l(`<h1 id="获取请求体" tabindex="-1">获取请求体 <a class="header-anchor" href="#获取请求体" aria-label="Permalink to &quot;获取请求体&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 测试时不要发get请求，浏览器输入网址默认就是get请求，而get请求是没有请求体的，所以看到的body是空白的，可以用原生form发一个post请求</span></span>
