import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.419948d5.js";const d=JSON.parse('{"title":"自定义 hook 函数","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Vue/Vue3/1.组合API/10.自定义hook函数.md","filePath":"program/frontend/Vue/Vue3/1.组合API/10.自定义hook函数.md","lastUpdated":1694412824000}'),p={name:"program/frontend/Vue/Vue3/1.组合API/10.自定义hook函数.md"},o=l(`<h1 id="自定义-hook-函数" tabindex="-1">自定义 hook 函数 <a class="header-anchor" href="#自定义-hook-函数" aria-label="Permalink to &quot;自定义 hook 函数&quot;">​</a></h1><p>在不使用 class 的情况下管理其中的状态数据，并且把一些逻辑性思维的东西抽取出来，放到一个可复用的功能函数当中</p><ul><li><p>使用 Vue3 的组合 API 封装的可复用的功能函数</p></li><li><p>自定义 hook 的作用类似于 vue2 中的 mixin 技术</p></li><li><p>自定义 Hook 的优势: 很清楚复用功能代码的来源, 更清楚易懂</p></li></ul><p>操作:</p><ul><li>src 下新建 hooks 文件夹</li><li>新建 hooks 文件：以 use 开头的 ts 文件</li></ul><p>功能代码示例</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
