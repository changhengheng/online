import{_ as s,o as n,c as a,Q as o}from"./chunks/framework.19358895.js";const m=JSON.parse('{"title":"Mongoose 插入文档","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter5/7.Mongoose插入文档.md","filePath":"program/frontend/Node/chapter5/7.Mongoose插入文档.md","lastUpdated":1697452647000}'),l={name:"program/frontend/Node/chapter5/7.Mongoose插入文档.md"},p=o(`<h1 id="mongoose-插入文档" tabindex="-1">Mongoose 插入文档 <a class="header-anchor" href="#mongoose-插入文档" aria-label="Permalink to &quot;Mongoose 插入文档&quot;">​</a></h1><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 1. 导入 mongoose</span></span>
