import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const d=JSON.parse('{"title":"生产模式","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/webpack/chapter1/23.生产模式.md","filePath":"program/frontend/webpack/chapter1/23.生产模式.md","lastUpdated":1694391214000}'),p={name:"program/frontend/webpack/chapter1/23.生产模式.md"},o=l(`<h1 id="生产模式" tabindex="-1">生产模式 <a class="header-anchor" href="#生产模式" aria-label="Permalink to &quot;生产模式&quot;">​</a></h1><p>生产模式是开发完成代码后，我们需要得到代码将来部署上线。</p><p>这个模式下我们主要对代码进行优化，让其运行性能更好。</p><p>优化主要从两个角度出发:</p><ol><li>优化代码运行性能</li><li>优化代码打包速度</li></ol><h2 id="生产模式准备" tabindex="-1">生产模式准备 <a class="header-anchor" href="#生产模式准备" aria-label="Permalink to &quot;生产模式准备&quot;">​</a></h2><p>我们分别准备两个配置文件来放不同的配置，开发模式下有开发模式的配置文件，生产环境下有生产环境的配置文件</p><ol><li><p>文件目录</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">├── webpack-test (项目根目录)</span></span>
