import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const u=JSON.parse('{"title":"Mongoose 删除文档","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter5/10.Mongoose删除文档.md","filePath":"program/frontend/Node/chapter5/10.Mongoose删除文档.md","lastUpdated":1697452647000}'),p={name:"program/frontend/Node/chapter5/10.Mongoose删除文档.md"},o=l(`<h1 id="mongoose-删除文档" tabindex="-1">Mongoose 删除文档 <a class="header-anchor" href="#mongoose-删除文档" aria-label="Permalink to &quot;Mongoose 删除文档&quot;">​</a></h1><p>准备工作：创建 novels 集合，添加数据，直接运行以下代码即可</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// data.js 生成数据</span></span>
