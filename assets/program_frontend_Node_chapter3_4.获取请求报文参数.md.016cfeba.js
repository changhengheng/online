import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.419948d5.js";const d=JSON.parse('{"title":"获取请求报文参数","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter3/4.获取请求报文参数.md","filePath":"program/frontend/Node/chapter3/4.获取请求报文参数.md","lastUpdated":1697287289000}'),p={name:"program/frontend/Node/chapter3/4.获取请求报文参数.md"},o=l(`<h1 id="获取请求报文参数" tabindex="-1">获取请求报文参数 <a class="header-anchor" href="#获取请求报文参数" aria-label="Permalink to &quot;获取请求报文参数&quot;">​</a></h1><p>express 框架封装了一些 API 来方便获取请求报文中的数据，并且兼容原生 HTTP 模块的获取方式</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 1.引入express模块</span></span>
