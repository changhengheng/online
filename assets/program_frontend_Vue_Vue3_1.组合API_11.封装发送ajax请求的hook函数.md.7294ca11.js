import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const g=JSON.parse('{"title":"封装发ajax请求的hook函数","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Vue/Vue3/1.组合API/11.封装发送ajax请求的hook函数.md","filePath":"program/frontend/Vue/Vue3/1.组合API/11.封装发送ajax请求的hook函数.md","lastUpdated":1694412824000}'),p={name:"program/frontend/Vue/Vue3/1.组合API/11.封装发送ajax请求的hook函数.md"},o=l(`<h1 id="封装发ajax请求的hook函数" tabindex="-1">封装发ajax请求的hook函数 <a class="header-anchor" href="#封装发ajax请求的hook函数" aria-label="Permalink to &quot;封装发ajax请求的hook函数&quot;">​</a></h1><p>封装发ajax请求的hook函数，并利用TS泛型强化类型检查</p><p>操作:</p><ul><li>src 下新建 hooks 文件夹</li><li>新建 hooks 文件：useRequest.ts</li></ul><p>功能代码示例</p><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> { ref } </span><span style="color:#F97583;">from</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">&#39;vue&#39;</span></span>
