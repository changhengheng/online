import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.19358895.js";const _=JSON.parse('{"title":"setup 测试","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Vue/Vue3/1.组合API/1.setup测试.md","filePath":"program/frontend/Vue/Vue3/1.组合API/1.setup测试.md","lastUpdated":1694412824000}'),l={name:"program/frontend/Vue/Vue3/1.组合API/1.setup测试.md"},e=p(`<h1 id="setup-测试" tabindex="-1">setup 测试 <a class="header-anchor" href="#setup-测试" aria-label="Permalink to &quot;setup 测试&quot;">​</a></h1><p>新的 option（配置项）</p><ul><li>所有的组合 API 函数都在此使用</li><li>只在程序初始化时执行一次</li><li>setup 函数如果返回对象, 对象中的属性或方法在模板中可以直接使用</li><li>setup 函数可以直接作为配置项使用，不需要引入</li></ul><p>测试代码：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
