import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.419948d5.js";const g=JSON.parse('{"title":"HTTP练习","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter1/51.HTTP练习.md","filePath":"program/frontend/Node/chapter1/51.HTTP练习.md","lastUpdated":1697287289000}'),t={name:"program/frontend/Node/chapter1/51.HTTP练习.md"},p=l(`<h1 id="http练习" tabindex="-1">HTTP练习 <a class="header-anchor" href="#http练习" aria-label="Permalink to &quot;HTTP练习&quot;">​</a></h1><p>搭建 HTTP 服务，响应一个 4 行 3 列的表格，并且要求表格有 隔行换色效果 ，且 点击 单元格能 高亮显示</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 引入模块</span></span>
