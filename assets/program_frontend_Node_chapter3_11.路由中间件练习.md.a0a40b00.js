import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.419948d5.js";const u=JSON.parse('{"title":"路由中间件练习","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter3/11.路由中间件练习.md","filePath":"program/frontend/Node/chapter3/11.路由中间件练习.md","lastUpdated":1697287289000}'),l={name:"program/frontend/Node/chapter3/11.路由中间件练习.md"},o=p(`<h1 id="路由中间件练习" tabindex="-1">路由中间件练习 <a class="header-anchor" href="#路由中间件练习" aria-label="Permalink to &quot;路由中间件练习&quot;">​</a></h1><p>如果 只需要对某一些路由进行功能封装 ，则就需要路由中间件</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">/**</span></span>
