import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const d=JSON.parse('{"title":"代码模块化","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter5/15.Mongoose代码模块化.md","filePath":"program/frontend/Node/chapter5/15.Mongoose代码模块化.md","lastUpdated":1697452647000}'),o={name:"program/frontend/Node/chapter5/15.Mongoose代码模块化.md"},p=l(`<h1 id="代码模块化" tabindex="-1">代码模块化 <a class="header-anchor" href="#代码模块化" aria-label="Permalink to &quot;代码模块化&quot;">​</a></h1><p>准备工作：</p><ol><li>新建 <code>代码模块化</code> 练习文件夹</li><li>新建 <code>index.js</code> 放数据库操作</li><li>新建 <code>db/db.js</code> 放封装的模块</li></ol><p>初步封装：</p><ul><li>封装连接数据库相关操作到 <code>db.js</code></li><li>使用 <code>success</code> 和 <code>error</code> 封装数据库操作，并在合适的时机执行</li></ul><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// db/db.js</span></span>
...
<span class="line"><span style="color:#24292E;">    console.</span><span style="color:#6F42C1;">log</span><span style="color:#24292E;">(</span><span style="color:#032F62;">&quot;连接失败&quot;</span><span style="color:#24292E;">);</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">);</span></span></code></pre></div>`,7),e=[p];function c(t,r,E,y,i,F){return n(),a("div",null,e)}const g=s(o,[["render",c]]);export{d as __pageData,g as default};
