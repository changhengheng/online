import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.19358895.js";const h=JSON.parse('{"title":"获取请求路径和查询字符串","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter1/48.获取请求路径和查询字符串.md","filePath":"program/frontend/Node/chapter1/48.获取请求路径和查询字符串.md","lastUpdated":1697287289000}'),l={name:"program/frontend/Node/chapter1/48.获取请求路径和查询字符串.md"},o=p(`<h1 id="获取请求路径和查询字符串" tabindex="-1">获取请求路径和查询字符串 <a class="header-anchor" href="#获取请求路径和查询字符串" aria-label="Permalink to &quot;获取请求路径和查询字符串&quot;">​</a></h1><p>和上一节功能一样，但是提取方式不一样</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 引入模块</span></span>
