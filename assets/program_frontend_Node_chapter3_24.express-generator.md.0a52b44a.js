import{_ as s,o as a,c as n,Q as p}from"./chunks/framework.19358895.js";const h=JSON.parse('{"title":"express-generator","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter3/24.express-generator.md","filePath":"program/frontend/Node/chapter3/24.express-generator.md","lastUpdated":1697287289000}'),e={name:"program/frontend/Node/chapter3/24.express-generator.md"},l=p(`<h1 id="express-generator" tabindex="-1">express-generator <a class="header-anchor" href="#express-generator" aria-label="Permalink to &quot;express-generator&quot;">​</a></h1><p><a href="https://express.nodejs.cn/en/starter/generator.html" target="_blank" rel="noreferrer">https://express.nodejs.cn/en/starter/generator.html</a></p><p>express-generator 是 express 官方提供的一个用来快速创建一个express应用骨架的工具。</p><p>全局安装这个包会暴露一个 <code>express</code> 命令</p><p>使用 <code>express -e xxx</code>：在xxx文件夹下创建一个支持ejs模板引擎的项目架子</p><p>处理404的两种方式：</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// generator创建的骨架app.js的处理方式</span></span>
