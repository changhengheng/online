import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.419948d5.js";const d=JSON.parse('{"title":"响应设置","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter3/7.响应设置.md","filePath":"program/frontend/Node/chapter3/7.响应设置.md","lastUpdated":1697287289000}'),l={name:"program/frontend/Node/chapter3/7.响应设置.md"},o=p(`<h1 id="响应设置" tabindex="-1">响应设置 <a class="header-anchor" href="#响应设置" aria-label="Permalink to &quot;响应设置&quot;">​</a></h1><p>express 框架封装了一些 API 来方便给客户端响应数据，并且兼容原生 HTTP 模块的获取方式</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 引入模块</span></span>
