import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.19358895.js";const A=JSON.parse('{"title":"数据个性化读取","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/Node/chapter5/14.Mongoose数据个性化读取.md","filePath":"program/frontend/Node/chapter5/14.Mongoose数据个性化读取.md","lastUpdated":1697452647000}'),p={name:"program/frontend/Node/chapter5/14.Mongoose数据个性化读取.md"},o=l(`<h1 id="数据个性化读取" tabindex="-1">数据个性化读取 <a class="header-anchor" href="#数据个性化读取" aria-label="Permalink to &quot;数据个性化读取&quot;">​</a></h1><ol><li><p>字段筛选</p><p>筛选可以获取文档中需要的某一些属性，而不是全部的属性</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">//0:不要的字段</span></span>
