import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.419948d5.js";const F=JSON.parse('{"title":"多进程打包提升打包构建速度","description":"","frontmatter":{},"headers":[],"relativePath":"program/frontend/webpack/chapter2/36.多进程打包提升打包构建速度.md","filePath":"program/frontend/webpack/chapter2/36.多进程打包提升打包构建速度.md","lastUpdated":1694391214000}'),p={name:"program/frontend/webpack/chapter2/36.多进程打包提升打包构建速度.md"},o=l(`<h1 id="多进程打包提升打包构建速度" tabindex="-1">多进程打包提升打包构建速度 <a class="header-anchor" href="#多进程打包提升打包构建速度" aria-label="Permalink to &quot;多进程打包提升打包构建速度&quot;">​</a></h1><h2 id="为什么" tabindex="-1">为什么 <a class="header-anchor" href="#为什么" aria-label="Permalink to &quot;为什么&quot;">​</a></h2><p>当项目越来越庞大时，打包速度越来越慢，甚至于需要一个下午才能打包出来代码。这个速度是比较慢的。</p><p>我们想要继续提升打包速度，其实就是要提升 js 的打包速度，因为其他文件都比较少。</p><p>而<strong>对 js 文件处理主要就是 eslint 、babel、Terser 三个工具</strong>，所以我们要提升它们的运行速度。</p><p>我们可以开启多进程同时处理 js 文件，这样速度就比之前的单进程打包更快了。</p><blockquote><p>Terser 你可能没听过，但是我们一直在用。之前说过，webpack会自动压缩js代码，就是Terser在做。只要是配置了生产模式，Terser就会自动激活。</p></blockquote><h2 id="是什么" tabindex="-1">是什么 <a class="header-anchor" href="#是什么" aria-label="Permalink to &quot;是什么&quot;">​</a></h2><p>多进程打包：开启电脑的多个进程同时干一件事，速度更快。</p><p><strong>需要注意：请仅在特别耗时的操作中使用，因为每个进程启动就有大约为 600ms 左右开销。</strong></p><h2 id="怎么用" tabindex="-1">怎么用 <a class="header-anchor" href="#怎么用" aria-label="Permalink to &quot;怎么用&quot;">​</a></h2><p>我们启动进程的数量就是我们 CPU 的核数。</p><ol><li><p>如何获取 CPU 的核数，因为每个电脑都不一样。</p><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// nodejs核心模块，直接使用</span></span>
